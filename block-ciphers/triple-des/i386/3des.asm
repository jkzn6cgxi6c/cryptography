...
; extern void __stdcall triple_des_key_schedule(unsigned char key[288])
; extern void __stdcall triple_des_encrypt(unsigned char buffer[8], const unsigned char key[288])
; extern void __stdcall triple_des_decrypt(unsigned char buffer[8], const unsigned char key[288])

PUBLIC _triple_des_key_schedule@4, _triple_des_encrypt@8, _triple_des_decrypt@8
